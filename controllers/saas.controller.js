  ...
  static async registerSchool(req, res, next) {
    try {
      ...
      if ((payment_gateway === 'razorpay' || paymentGateway === 'razorpay') && (req.body.razorpay_signature || req.body.razorpaySignature)) {
        ...
        const paymentId = payment_transaction_id || paymentTransactionId || req.body.razorpay_payment_id;
        ...
        if (expectedSignature !== signature) {
          return ApiResponse.error(res, 'Invalid Razorpay payment signature detected.', null, 400);
        }
      }

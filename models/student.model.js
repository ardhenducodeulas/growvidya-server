...
class StudentModel {
  static async getAll(schoolId, { search = '', classId = '', sectionId = '', status = '', admissionDate = '', limit = 12, offset = 0 } = {}) {
  ...
  static async create(data) {
    ...
    const sql = `
      INSERT INTO student_master (
        school_id, academic_year, admission_number, admission_date, roll_number,
